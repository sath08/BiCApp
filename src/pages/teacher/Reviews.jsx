  ...
  return (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-teal-700 to-teal-500 rounded-2xl p-5 text-white">
        ...
        <p className="text-teal-100 text-sm">{mockPendingReviews.length} essays awaiting review</p>
      </div>
          ...
          >
            <Card hover>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Link
                  to={`/teacher/reviews/${r.id}`}
                  className="bg-gradient-to-r from-teal-600 to-teal-400 text-white font-bold px-5 py-2.5 rounded-xl hover:from-teal-700 hover:to-teal-500 transition-all text-sm whitespace-nowrap shadow-md shadow-teal-200"
                >
                  ✍️ Start Review →
                </Link>
              </div>
