...
export default function Writing() {
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-6">
      ...
      <div className="bg-gradient-to-r from-orange-700 to-orange-600 rounded-2xl p-5 text-white">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl p-4 text-center shadow-sm border border-purple-50">
          ...
          <div className="text-xs text-gray-600 mt-1">✏️ Needs Revision</div>
        </div>
      </div>
      ...
      {showForm ? (
        <Card>
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => setShowForm(false)} className="text-gray-600 hover:text-red-700 font-bold text-xl">×</button>
          </div>
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-r from-orange-700 to-orange-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-orange-200 flex items-center justify-center gap-2 text-lg"
        >
          ✍️ Write a New Essay
        </motion.button>
      )}
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl hover:bg-purple-50 transition-colors group">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-gray-600 bg-gray-100 px-2 py-0.5 rounded-full capitalize">{essay.assignment_type}</span>
                      </div>
                      <p className="text-xs text-gray-600">{essay.essay_type} • by {essay.author}</p>
                      {essay.submitted_at && (
